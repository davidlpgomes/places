...
Review::Review(const std::string &comment, const unsigned char rating,
...
unsigned char Review::getRating() const { return rating; }
...
const boost::posix_time::ptime &Review::getDate() const { return date; }
